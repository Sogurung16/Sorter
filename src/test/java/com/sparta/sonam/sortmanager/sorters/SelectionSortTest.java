...
@DisplayName("Should SelectionSort the provided array in ascending order")
class SelectionSortTest implements SortersTestInterface{
    @Override
    @Test
    @DisplayName("Returns a SelectionSorted array")
    public void sortArrayTest() {
        int[] unsortedArray = new int[]{24,5,2,19,67,78,59,99};

        int[] expectedSortedArray = new int[]{2,5,19,24,59,67,78,99};
        int[] actualSortedArray = SortFactory.getSortingAlgorithm(5).sortArray(unsortedArray);
    ...
    @Override
    @Test
    @DisplayName("Returns a SelectionSorted array. Test for value zero in array")
    ...
    @Override
    @Test
    @DisplayName("Returns a SelectionSorted array. Test for negative values in array")
    ...
    @Override
    @Test
    @DisplayName("Returns a SelectionSorted array. Test for repeated values in array")
    ...
    @Override
    @Test
    @DisplayName("Returns a SelectionSorted even size array of length 8")
    ...
    @Override
    @Test
    @DisplayName("Returns a SelectionSorted odd size array of length 7")
