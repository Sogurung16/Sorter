...
class BinarySearchTreeSortTest implements SortersTestInterface{
    @Override
    @Test
    @DisplayName("Returns a BinarySortedTree array")
    ...
    @Override
    @Test
    @DisplayName("Returns a BinarySortedTree array. Test for value zero in array")
    ...
    @Override
    @Test
    @DisplayName("Returns a BinarySortedTree array. Test for negative values in array")
    ...
    @Override
    @Test
    @DisplayName("Returns a BinarySortedTree array. Test for repeated values in array")
    ...
    @Override
    @Test
    @DisplayName("Returns a BinarySortedTree even size array of length 8")
    ...
    @Override
    @Test
    @DisplayName("Returns a BinarySortedTree odd size array of length 7")
