...
class InsertionSortTest implements SortersTestInterface{
    @Override
    @Test
    @DisplayName("Returns a InsertionSorted array")
    ...
    @Override
    @Test
    @DisplayName("Returns a InsertionSorted array. Test for value zero in array")
    ...
    @Override
    @Test
    @DisplayName("Returns a InsertionSorted array. Test for negative values in array")
    ...
    @Override
    @Test
    @DisplayName("Returns a InsertionSorted array. Test for repeated values in array")
    ...
    @Override
    @Test
    @DisplayName("Returns a InsertionSorted even size array of length 8")
    ...
    @Override
    @Test
    @DisplayName("Returns a InsertionSorted odd size array of length 7")
